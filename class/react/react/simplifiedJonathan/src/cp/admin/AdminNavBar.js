...
export default class ExtNavBar extends Component {
    render() {
        ...
        const phoneSystemRelated = {'/cp/admin/company_info' : '1'};
                ...
                <div className="lr-zero">
                    ...
                    <div className="collapse navbar-collapse lr-zero" id="bs-example-navbar-collapse-1">
                        ...
                        <ul className="nav navbar-nav s48p">
                            <NavItem to="/cp/admin/phone_system" requires="" currentPrivs={currentPrivs} related={phoneSystemRelated}>Phone System</NavItem>
                            <NavItem to="/cp/admin/users" requires="" currentPrivs={currentPrivs}>Users</NavItem>
                        </ul>
