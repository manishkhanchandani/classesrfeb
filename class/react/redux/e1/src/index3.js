...
import { createStore, combineReducers } from 'redux'; //call create store
...
const store = createStore(combineReducers({mathReducer, userReducer})); //takes two params, first parameter is reducer, reducer is part which takes action and changes your state, and another parameter is just a initial application state which may be array or a simple number
