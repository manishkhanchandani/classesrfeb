  ...
  function googleLogin(googleLoginTemplate, googleLoginService, configs, $location) {
    return {
          ...
          link: function(scope, elem, attrs) {
              var clientId = configs[$location.host()].clientId; //'754890700194-4p5reil092esbpr9p3kk46pf31vkl3ub.apps.googleusercontent.com';
              var apiKey = configs[$location.host()].apiKey; //'AIzaSyCWqKxrgU8N1SGtNoD6uD6wFoGeEz0xwbs';
