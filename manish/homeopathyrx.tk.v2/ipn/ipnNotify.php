...
try {
  ...
  define('CASE_PATH', '/homeopathyClassical/cases');
  define('USER_PATH', '/homeopathyClassical/users');
  define('PAYMENT_PATH', '/homeopathyClassical/payments');
  define('RX_PATH', '/homeopathyRx/remedies');
  ...
  if (strcmp ($res, "VERIFIED") == 0) {
    ...
    save_data($firebase, $id, $uid, $data);
    
    processData($firebase, $id, $uid, $data);
