...
$consonants = array("b", "c", "d", "v", "g", "t", "h", "m", "n", "p", "q", "z", "j");
...
function randomName() {
   return ucfirst("" . randConsonant() . "" . randVowel() . "" . "" . randConsonant() . "" . randVowel() . "" . randVowel() . "");
}
...
$arr['email'] = $arr['first_name'].'.'.$arr['last_name'].'@mkgalaxy.com';
...
$title = 'Homeopathy And Vaccinations';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
