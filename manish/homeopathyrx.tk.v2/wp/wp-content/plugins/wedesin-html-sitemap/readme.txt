...
WeDesIn HTML Sitemap adds list of all the pages, posts and custom post types to any webpage using a shortcode [html-sitemap]. To list attachments use the [attachment-sitemap] shortcode.
