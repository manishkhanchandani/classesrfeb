              ...
              if (snapshot.val()) {
                ...
                angular.forEach(snapshot.val(), function(value, key) {
                  ...
                  firebase.database().ref('/users').child(uid).once('value', function (snapshotUser) {
                    ...
                    var distance = null;
                    if (scope.lat && scope.lng && scope.data[uid].ipDetails) {
                      distance = dataService.distance(scope.lat, scope.lng, scope.data[uid].ipDetails.lat, scope.data[uid].ipDetails.lng);
