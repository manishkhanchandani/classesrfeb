...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO essay_questions (exam_subject, exam_year, exam_question, exam_sorting) VALUES (%s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['exam_sorting'], "int"));
...
mysql_select_db($database_connLaw, $connLaw);
$query_Recordset1 = "SELECT * FROM essay_questions ORDER BY exam_subject ASC, exam_sorting ASC, question_id ASC";
...
<textarea name="exam_question" cols="60" rows="10" id="exam_question"></textarea>
   ...
   <p>
     <label for="exam_sorting"><strong>Sorting:</strong></label>
     <input name="exam_sorting" type="text" id="exam_sorting" value="0">
   </p>
   <p>
    ...
    <tbody>
      ...
      <?php do { ?>
        <tr>
          ...
          <td valign="top"><?php echo nl2br($row_Recordset1['exam_sorting']); ?></td>
