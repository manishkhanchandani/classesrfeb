...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <p><strong>Criminal Checklist </strong></p>
      <ol>
        <li>Formation
          <ol>
...
<ol>
            <li>Governing Law (Common or UCC)
                <?php echo showHideText('isUCC', '(Rule)', '<span class="rule">'.Contracts::isUCC.'</span>'); ?>
            </li>
            <li>Valid Contract
               <?php echo showHideText('validContract', '(Rule)', '<span class="rule">'.Contracts::contractFormation.'</span>'); ?>
               <?php echo showHideText('merchant', 'Merchant (Rule)', '<span class="rule">'.Contracts::merchant.'</span>'); ?>
              <ol>
                <li>Mutual Assent
                  <ol>
                    <li>Offer
                       <?php echo showHideText('offer', '(Rule)', '<span class="rule">'.Contracts::offer.'</span>'); ?>
                      <ol>
